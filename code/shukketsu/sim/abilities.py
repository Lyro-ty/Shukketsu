...
ABILITIES: dict[str, AbilityDef] = {
    ...
    "backstab": AbilityDef(
        ...
        spell_id=26863,
        energy_cost=60,
        flat_damage=255,  # TBC Rank 10 (spell 26863): 150% weapon + 255
    ...
    "ambush": AbilityDef(
        ...
        spell_id=27441,
        energy_cost=60,
        flat_damage=335,  # TBC Rank 7 (spell 27441): 275% weapon + 335
    ...
    "eviscerate": AbilityDef(
        ...
        flat_damage=60,  # TBC Rank 10 base min at 0 CP; range 60-180 + 185*CP
        ap_coefficient=0.03,
        flags={
